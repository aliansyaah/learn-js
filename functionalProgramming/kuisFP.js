...
// TODO
const book = books.filter((item) => item.sales > 1000000)
console.log(book);


const greatAuthors = book.map((item2) => { return `${item2.author} adalah penulis buku ${item2.title} yang sangat hebat!` })
